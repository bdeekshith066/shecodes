...
firebase_config = {
    "apiKey": "AIzaSyBo4mwKvLCMFbIXNV5qSI0HUCVZw1Gx1Do",
    "authDomain": "cooling-cap-ba603.firebaseapp.com",
    "databaseURL": "https://cooling-cap-ba603-default-rtdb.asia-southeast1.firebasedatabase.app",
    "projectId": "cooling-cap-ba603",
    "storageBucket": "cooling-cap-ba603.appspot.com",
    "messagingSenderId": "571732386432",
    "appId": "1:571732386432:web:bc644da4b8d3a30f59bc65",
    "measurementId": "YG-WN6EFJRBR9"
}
...
def app():
    ...
    # Patient info
    patient_info = {
        'deekhsith': {'Name': 'Deek', 'Gender': 'Male', 'Cancer Type': 'Kidney', 'Headache': False},
        'sanjana_wg': {'Name': 'Sanjana', 'Gender': 'Female', 'Cancer Type': 'Breast', 'Headache': False},
